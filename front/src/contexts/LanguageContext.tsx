...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "hero.title": "Watch 10,000+ TV Channels",
    ...
    "donate.description": "Help us keep 10,000+ channels free for everyone. Your donation directly supports our infrastructure and allows us to serve millions of users worldwide.",
    ...
    "donate.why1": "Keep all 10,000+ channels completely free",
  ...
  ru: {
    ...
    "hero.title": "Смотрите 10,000+ ТВ Каналов",
    ...
    "donate.description": "Помогите нам сохранить 10,000+ каналов бесплатными для всех. Ваше пожертвование напрямую поддерживает нашу инфраструктуру и позволяет обслуживать миллионы пользователей по всему миру.",
    ...
    "donate.why1": "Сохранить все 10,000+ каналов полностью бесплатными",
  ...
  uz: {
    ...
    "hero.title": "10,000+ TV Kanallarni Tomosha Qiling",
    ...
    "donate.description": "Barcha uchun 10,000+ kanallarni bepul saqlashga yordam bering. Sizning xayriyangiz to'g'ridan-to'g'ri infrastrukturamizni qo'llab-quvvatlaydi va butun dunyo bo'ylab millionlab foydalanuvchilarga xizmat ko'rsatishga imkon beradi.",
    ...
    "donate.why1": "Barcha 10,000+ kanallarni to'liq bepul saqlash",
